...
var statusTag = document.getElementById("ISSN");
...
{   
    let confirmDel = confirm("Are you sure you want to delete this research?");
...
function updateNote(noteId, title, filterDesc, status) {
    ...
    popupTitle.innerText = "Update a Research";
    addBtn.innerText = "Update Research";
}
...
addBtn.addEventListener("click" , e=>{
    ...
    let status = statusTag.value.trim();

    if(noteTitle || noteDesc || status)
    {
